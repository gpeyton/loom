...
If found, **read and follow instructions in `champion-pr-merge.md`**.
...
If found, **read and follow instructions in `champion-issue-promo.md`**.
...
If found, **read and follow instructions in `champion-issue-promo.md`**. Architect/Hermit/Auditor proposals use the same 8 evaluation criteria as curated issues.
...
If found, **read and follow instructions in `champion-epic.md`**. Epics have their own evaluation criteria focused on structure and phase decomposition.
...
See `champion-pr-merge.md` Step 5.5 for the complete implementation.
...
After completing work, generate a completion report. See `champion-common.md` for report format and examples.
...
See `champion-common.md` for full probe protocol details.
