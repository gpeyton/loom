...
**For templates and examples**, read `architect-patterns.md`.
...
**For epic templates and workflow**, read `architect-patterns.md`.
...
**For detailed label workflow and exceptions**, read `architect-reference.md`.
